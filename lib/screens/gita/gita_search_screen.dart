...
class GitaSearchScreen extends StatelessWidget {
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text('SEARCH', style: SacredTextStyles.sectionLabel(fontSize: 10).copyWith(color: SacredColors.parchment.withOpacity(0.6), letterSpacing: 4)),
                  ],
                ),
              ),
              const Expanded(
                child: Center(
                  child: Padding(
                    ...
                    child: Text(
                      'Search is coming soon.\nBrowse chapters to find verses.',
